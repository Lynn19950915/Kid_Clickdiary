<?php
	...
	if(isset($_POST["username"])){
		...
		if($stmt->rowCount()==0){
            ...
            $sql2="SELECT * FROM `account` WHERE level=2";
	...
	<script>
		$(document).ready(function(){
            $("#eye1").on("click", function(event){
			    ...
			    $("#password1").replaceWith(`<input id="password2" name="password2" type="text" value="${password1}" style="width: 65%" autocomplete="off">`);
                $("#eye1").hide();
                $("#eye2").show();
			})
            ...
            $("#eye2").on("click", function(event){
			    ...
			    $("#password2").replaceWith(`<input id="password1" name="password1" type="password" value="${password2}" style="width: 65%" autocomplete="off">`);
                $("#eye1").show();
                $("#eye2").hide();
			})
                ...
                $.ajax({ 
                    ...
                    success: function(data){ 
                        ...
                        if(data=="Invalid Attempt"){
                            ...
                            $.alert({
                                title: "<i class='fas fa-times-circle' style='color: red'></i> 登入錯誤",
								content: "登入失敗，請檢查信箱或密碼輸入！",
                            })
                        }else{
    ...
    <div class="wrapper">
        ...
        <form id="loginForm">
            ...
            <div class="input-group form-group fadeIn second">
                ...
                <input id="password1" name="password1" type="password" placeholder="請輸入密碼" required style="width: 65%" autocomplete="off">
