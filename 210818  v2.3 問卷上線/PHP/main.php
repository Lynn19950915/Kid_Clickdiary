            ...
            $.ajax({ 
                ...
                success: function(data){
                    ...
                    for($i=0; $i<data.length; $i++){
						...
						if(data[$i].active==0){
                            append_row.insertCell(5).innerHTML="<span style='padding: 7.5%; color: #FFFFFF; background-color: #003B83; border-radius: 5px'><b>D 關閉</b></span>";
                        }else if(data[$i].active==1){
                            append_row.insertCell(5).innerHTML="<span style='padding: 7.5%; color: #FFFFFF; background-color: orange; border-radius: 5px'><b>A 開啟</b></span>";
                        }else if(data[$i].active==2){
                            append_row.insertCell(5).innerHTML="<span style='padding: 7.5% 5%; background-color: #FFFF00; border-radius: 5px'><b>B 測試中</b></span>";
                        }else if(data[$i].active==2.5){
                            append_row.insertCell(5).innerHTML="<span style='padding: 7.5% 5%; background-color: #CCCCD6; border-radius: 5px'><b>準備上線</b></span>";
                        }else{
                            append_row.insertCell(5).innerHTML="<span style='padding: 7.5% 5%; background-color: #C3D825; border-radius: 5px'><b>C 已上線</b></span>";
                        }                        
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if(data=="Invalid Format"){
                            ...
                            $.alert({
                                title: "<i class='fas fa-times-circle' style='color: red'></i> 欄位名稱錯誤",
                                content: "<b style='color: blue'>N 欄</b> 表頭應為 <b style='color: red'>[random]</b>，請檢查欄位是否存在或順序有誤！",
                            })
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if(data=="Invalid Format"){
                            ...
                            $.alert({
                                title: "<i class='fas fa-times-circle' style='color: red'></i> 欄位名稱錯誤",
                                content: "<b style='color: blue'>C 欄</b> 表頭應為 <b style='color: red'>[points]</b>，請檢查欄位是否存在或順序有誤！",
                            })    
                            ...
                            $.alert({
                                title: "<i class='fas fa-times-circle' style='color: red'></i> 必填欄位缺漏",
                                content: "系統偵測到您檔案中的 <b style='color: red'>[points]</b> 欄位有漏填，此為必填欄位，每行都需填寫唷！",
                            })
                                        ...
                                        $.ajax({
											...
											success: function(data){
                                                ...
                                                $.confirm({
                                                    ...
                                                    content: "樣本名單已上傳！專案將會依您設定的日期自動上線 (每日 0、6、12、18 時執行排程)，請耐心等待！",
                                                    buttons:{
                                                        "OK": function(){
                                                            window.location.href="./main.php";
                                                        }
...
<body>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding-bottom: 1em">
                <form id="projectAppendForm"><br>
					...
					<div class="row">
                        <div class="col-sm-5 pl-0 pr-0">
                            <div class="input-group-text">D. 專案類型：</div>
                        </div>
                        <div class="col-sm-7 pl-0 pr-0">
							<select name="type" class="form-control btn-outline-secondary">
                                <option value="">請選擇</option>
								<option value="Q">問卷</option>
								<option value="D">日記</option>
                            </select>
                        </div>
                    </div><br>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding-bottom: 1em">
                <form id="submitCsvForm"><br>
					...
					<div class="row">
                        <div class="col-sm-4 pl-0 pr-0">
                            <div class="input-group-text">B. 點數：</div>
                        </div>
                        <div class="col-sm-8 pl-0 pr-0">
					...
					<div class="row">
                        <div class="col-sm-4 pl-0 pr-0">
                            <div class="input-group-text">C. 上線日期：</div>
                        </div>
                        <div class="col-sm-8 pl-0 pr-0">
                            <input class="form-control btn-outline-secondary" type="date" name="start_date" style="font-size: 0.9em" required>
                        </div>
                    </div>
					<p class="row" style="font-size: 0.8em; margin: 2.5% auto"><b><i class='fa fa-info-circle'></i> 截止日即專案上線的最後一天，隔日將會關閉。</b></p>
					<div class="row">
                        <div class="col-sm-4 pl-0 pr-0">
                            <div class="input-group-text">D. 截止日期：</div>
                        </div>
                        <div class="col-sm-8 pl-0 pr-0">
                    ...
                    <div class="row">
                        <div class="col-sm-4 pl-0 pr-0">
                            <div class="input-group-text">E. 樣本清單：</div>
                        </div>
                        <div class="col-sm-8 pl-0 pr-0">
    ...
    <div class="container" style="width: 75%; padding-top: 1%">
        <div class="card" style="border: 0.1em solid #FCD217">     
            ...
            <div class="card-body show" style="padding: 2% 10% 0% 10%">
                ...
                <table class="table rule" style="text-align: center">
                    ...
                    <tr>
                        <td style="line-height: 1.5em; vertical-align: middle"><span style="padding: 10%; color: #FFFFFF; background-color: orange; border-radius: 5px"><b>A 開啟</b></span></td>
                        <td style="line-height: 1.5em; vertical-align: middle">專案建立後，尚未上傳問題</td>
                        <td style="line-height: 1.5em; vertical-align: middle"><button class="btn btn-primary"><i class="fas fa-upload"></i></button></td>
                    </tr>
                    <tr>
                        <td style="line-height: 1.5em; vertical-align: middle"><span style="padding: 10% 7.5%; background-color: #FFFF00; border-radius: 5px"><b>B 測試中</b></span></td>
                        <td style="line-height: 1.75em; vertical-align: middle">上傳題目後，尚未確認上線（內部測試）<br>註：您可重複上傳題目，惟<b style="color: red">先前的版本內容及資料將被覆寫取代</b></td>
                    ...
                    <tr>
                        <td style="line-height: 1.5em; vertical-align: middle"><span style="padding: 10% 7.5%; background-color: #C3D825; border-radius: 5px"><b>C 已上線</b></span></td>
                        <td style="line-height: 1.75em; vertical-align: middle">上傳樣本清單後即完成上線（正式施測）<br>註：此時<b style="color: red">不可重新上傳問題</b>，上線前請確認題目為最終定版</td>
                    ...
                    <tr>
                        <td style="line-height: 1.5em; vertical-align: middle"><span style="padding: 10%; color: #FFFFFF; background-color: #003B83; border-radius: 5px"><b>D 關閉</b></span></td>
                        <td style="line-height: 1.5em; vertical-align: middle">專案中止或已結束</td>
		...
		<?php if($_SESSION["acc_info"]["level"]==1){?>
			<div><button class="btn btn-secondary" id="create_project2" style="margin: 1%"><i class="fas fa-plus"></i> 專案</button></div>
		<?php }?>
		<div style="float: left; margin: 1% auto; padding-left: 1.25%">▼ 點擊<span style="color: blue">藍字</span>可進行排列</div>
		<div style="float: right; margin: 0.5% auto">搜尋：<input id="search"></div>
	</div><br>
    ...
    <div class="container" style="margin: 1.5% 5%">
        <table id="project_list" class="table table-striped" style="text-align: center; width: 120%" cellspacing="0">
            <thead>
				<td>日記</td>
                <td>專案號</td>
                <td style="width: 12.5%">專案名稱</td>
                <td>
					<?php
                        if($c=="name" and $s==1){
                        echo '<a href="./main.php?c=name&s=2"><b>負責人 ▲</b></a>';
                        }else if($c=="name" and $s==2){
                        echo '<a href="./main.php?c=name&s=1"><b>負責人 ▼</b></a>';  
                        }else{
                        echo '<a href="./main.php?c=name&s=1">負責人</a>';
                        }
                    ?>
				</td>
                <td>樣本數</td>
                <td style="width: 10%">
					<?php
                        if($c=="active" and $s==1){
                        echo '<a href="./main.php?c=active&s=2"><b>專案狀態 ▲</b></a>';
                        }else if($c=="active" and $s==2){
                        echo '<a href="./main.php?c=active&s=1"><b>專案狀態 ▼</b></a>';  
                        }else{
                        echo '<a href="./main.php?c=active&s=1">專案狀態</a>';
                        }
                    ?>
				</td>
                <td>上傳題目</td>
                <td>預覽填寫</td>
                <td style="line-height: 1em">下載<br><b style="color: red">測試</b>資料</td>
				<td>確認上線</td>
                <td>目前回收</td>
				<td style="line-height: 1em">下載<br><b style="color: red">正式</b>資料</td>
                <td>
					<?php
                        if($c=="end_date" and $s==1){
                        echo '<a href="./main.php?c=end_date&s=2"><b>截止日期 ▲</b></a>';
                        }else if($c=="end_date" and $s==2){
                        echo '<a href="./main.php?c=end_date&s=1"><b>截止日期 ▼</b></a>';  
                        }else{
                        echo '<a href="./main.php?c=end_date&s=1">截止日期</a>';
                        }
                    ?>
				</td>
				<td>關閉專案</td>
    ...
    <script>
		...
		function closing(project_id){
            $.confirm({
				title: "",
				content: "注意：<br>專案關閉後<b style='color: red'>即不再接受任何回應</b>，請再次確認是否關閉？",
				buttons:{
					"返回": function(){},
