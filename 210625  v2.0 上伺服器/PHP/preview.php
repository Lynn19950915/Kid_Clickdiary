...
<head>
    ...
    <script src="http://benalman.com/projects/jquery-misc-plugins"></script>
                        ...
                        for(var i=0; i<qsetting.length; i++){
                            ...
                            if(qsetting[i]["type"]==0){
                                ...
                                if(opt_length<=25){
                                    ...
                                    for(var l=0; l<qsetting[i]["opt_txt"].length; l++){
                                        var o_txt=$("<input>").attr({"type": "radio", "name": qsetting[i]["q_id"]+"-"+qsetting[i]["q_sn"], "value": qsetting[i]["opt_value"][l], "note": qsetting[i]["note"][l], "skip": qsetting[i]["skip"][l], "skips": skips, "required": true});
                                    ...
                                    for(var l=0; l<qsetting[i]["opt_txt"].length/2; l++){
                                        var o_txt1=$("<input>").attr({"type": "radio", "name": qsetting[i]["q_id"]+"-"+qsetting[i]["q_sn"], "value": qsetting[i]["opt_value"][l], "note": qsetting[i]["note"][l], "skip": qsetting[i]["skip"][l], "skips": skips, "required": true});
                                    ...
                                    for(var l; l<qsetting[i]["opt_txt"].length; l++){
                                        var o_txt2=$("<input>").attr({"type": "radio", "name": qsetting[i]["q_id"]+"-"+qsetting[i]["q_sn"], "value": qsetting[i]["opt_value"][l], "note": qsetting[i]["note"][l], "skip": qsetting[i]["skip"][l], "skips": skips, "required": true});
                            ...
                            //1: 複選題
                                ...
                                if(opt_length<=25){
                                    var o_all=$("<div>").attr({"id": qsetting[i]["q_id"]+"-"+qsetting[i]["q_sn"], "class": "btn-group btn-group-toggle col-sm-12", "data-toggle": "buttons"});
                                    for(var l=0; l<qsetting[i]["opt_txt"].length; l++){
                                        var o_txt=$("<input>").attr({"type": "checkbox", "name": qsetting[i]["q_id"]+"-"+qsetting[i]["q_sn"], "value": qsetting[i]["opt_value"][l], "note": qsetting[i]["note"][l], "skip": qsetting[i]["skip"][l], "skips": skips, "disjoint": qsetting[i]["disjoint"][l]});
                                        var o_lbl=$("<label>").html(qsetting[i]["opt_txt"][l]).attr({"class": "btn btn-outline-secondary", "style": "font-size: 0.85em"});
                                        o_txt.appendTo(o_lbl);
                                        o_lbl.appendTo(o_all);
                                    }
                                    ...
                                    var o_all1=$("<div>").attr({"class": "btn-group-vertical btn-group-toggle col-sm-6", "style": "vertical-align: text-top"});
                                    for(var l=0; l<qsetting[i]["opt_txt"].length/2; l++){
                                        var o_txt1=$("<input>").attr({"type": "checkbox", "name": qsetting[i]["q_id"]+"-"+qsetting[i]["q_sn"], "value": qsetting[i]["opt_value"][l], "note": qsetting[i]["note"][l], "skip": qsetting[i]["skip"][l], "skips": skips, "disjoint": qsetting[i]["disjoint"][l]});
                                        var o_lbl1=$("<label>").html(qsetting[i]["opt_txt"][l]).attr({"class": "btn btn-outline-secondary", "style": "font-size: 0.85em"});
                                        o_txt1.appendTo(o_lbl1);
                                        o_lbl1.appendTo(o_all1);
                                    }
                                    ...
                                    var o_all2=$("<div>").attr({"class": "btn-group-vertical btn-group-toggle col-sm-6", "style": "vertical-align: text-top"});
                                    for(var l; l<qsetting[i]["opt_txt"].length; l++){
                                        var o_txt2=$("<input>").attr({"type": "checkbox", "name": qsetting[i]["q_id"]+"-"+qsetting[i]["q_sn"], "value": qsetting[i]["opt_value"][l], "note": qsetting[i]["note"][l], "skip": qsetting[i]["skip"][l], "skips": skips, "disjoint": qsetting[i]["disjoint"][l]});
                                        var o_lbl2=$("<label>").html(qsetting[i]["opt_txt"][l]).attr({"class": "btn btn-outline-secondary", "style": "font-size: 0.85em"});
                                        o_txt2.appendTo(o_lbl2);
                                        o_lbl2.appendTo(o_all2);
                                    }
